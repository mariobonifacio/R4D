...
```{r}
### This code removes the original categorical variables for a skinnier data frame; Can reference cat_facts if needed
...
flights %>% ##
  ...
  ggplot(mapping = aes(x=log(dep_delay),y=ct)) +
  geom_line()
