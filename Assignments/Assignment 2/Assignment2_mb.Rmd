...
Only one field among those remaining, **wind gust**, is concerning due to the number of n/a entries. My fear is that these incomplete entries are biased -- that is, we may be telling a story that is based on a disproportionate sample of the data.
```{r}
flt_wx %>%
