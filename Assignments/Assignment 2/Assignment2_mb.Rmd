...
* Fields with too few observations or with too many missing observations to be representative, and
* Fields that will require transformation
...
Only one field among those remaining, **wind gust**, is concerning due to the number of entries in which it's missing. The following fields will need to be transformed in the succeeding ways:
